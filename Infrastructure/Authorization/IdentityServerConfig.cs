...
namespace Infrastructure.Authorization
{
    ...
    {
        public const string ApiName = "managerial_api";
        public const string ApiFriendlyName = "Managerial API";
        public const string ManagerialClientID = "managerial_spa";
